...
public class BrowserSettings implements OnSharedPreferenceChangeListener,
    ...
    private static final String IPAD_USERAGENT_IOS4 = "Mozilla/5.0 (iPad; U; "+
        "CPU OS 4_0 like Mac OS X; en-us) AppleWebKit/531.21.10 "+
        "(KHTML, like Gecko) Version/4.0.4 Mobile/7B500 Safari/531.21.10";
    ...
    public boolean enableCrashRecovery() {
        return mPrefs.getBoolean(PREF_CRASH_RECOVERY, false);
    }

    public boolean enableVirtualMouse() {
        return mPrefs.getBoolean(PREF_VIRTUAL_MOUSE, true);
    }
// STA extended end.
