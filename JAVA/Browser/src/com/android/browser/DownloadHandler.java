...
public class DownloadHandler {
     ...
     * @param refererUrl The full url to the Referer
     ...
     */
    public static void onDownloadStart(Activity activity, String refererUrl, String url,
        ...
        onDownloadStartNoStream(activity, refererUrl, url, userAgent, contentDisposition,
     ...
     * @param privateBrowsing If the request is coming from a private browsing tab.
     */
    /*package */ static void onDownloadStartNoStream(Activity activity, String refererUrl,
