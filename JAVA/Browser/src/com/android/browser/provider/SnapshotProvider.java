...
public class SnapshotProvider extends ContentProvider {
    ...
    static final String TAG = "snapshots";
    ...
    public boolean onCreate() {        
        ...
        Log.v(TAG, "browser SnapshotProvider register EJECT and UNMOUNTED action filter.");
        return true;
    }
    ...
    final BroadcastReceiver mExternalStorageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.v(TAG, "browser SnapshotProvider onReceive  intent:"+intent);
            if (mOpenHelper != null) {
                try {
                    mOpenHelper.close();
                    Log.v(TAG, "browser SnapshotProvider close db file done.");
                } catch (Throwable t) {
