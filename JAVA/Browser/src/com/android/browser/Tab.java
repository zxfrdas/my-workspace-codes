...
class Tab implements PictureListener {
    ...
    Tab(WebViewController wvcontroller, WebView w, Bundle state) {
        ...
        Log.i("BROWSER-VERSION", "Browser Apk Version: (Based CL:572229,  Log This Msg Date:2012.04.11,  Log Msg By: zb.wu");
        ...
        mDownloadListener = new DownloadListener() {
            public void onDownloadStart(String url, String userAgent,
                    ...
                    long contentLength) {
                    String refererUrl = mMainView.getUrl();
                mWebViewController.onDownloadStart(Tab.this, refererUrl, url, userAgent, contentDisposition,
        ...
        if (mSubView == null) {
            ...
            mSubView.setDownloadListener(new DownloadListener() {
                public void onDownloadStart(String url, String userAgent,
                        String contentDisposition, String mimetype,
                        long contentLength) {
                        String refererUrl = mSubView.getUrl();
                    mWebViewController.onDownloadStart(Tab.this, refererUrl, url, userAgent,
